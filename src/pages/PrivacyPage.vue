    ...
    <q-card flat class="my-card bg-grey">
      <q-card-section class="q-pt-none">
        ...
        <p>
          ...
          <strong>A. Personal Information:</strong> We collect the basics, like your name, email, and address. Don’t worry; we won’t ask for your life story—unless it involves magical talking unicorns.
        </p>
        <p>
          <strong>B. Payment Information:</strong> When you buy our widgets (and we know you want to), we’ll need your credit card info. We store this securely, and we definitely won’t spend it on pizza (even if we’re tempted).
        </p>
        <p>
        ...
        <p>
          ...
          <ul>
            <li>Process your orders faster than a cheetah on roller skates.</li>
            <li>Improve our website so it’s easier to navigate than a squirrel on a power line.</li>
        ...
        <p>
          ...
          <ul>
            <li>Request access to your personal information (we’ll dig it up faster than a dog looking for buried treasure).</li>
        ...
        <p>
          ...
          We’re not a fan of kids under 13 using our site without parental supervision. If we find out we’ve collected information from a child, we’ll make it disappear faster than a magician’s rabbit.
        </p>
        <p>
          <strong>7. Changes to This Policy</strong><br>
          We might update this privacy policy from time to time. If we do, we’ll notify you like a friendly neighborhood spider (but without the web).
        </p>
        <p>
          <strong>8. Contact Us</strong><br>
          If you have any questions or concerns about this policy, feel free to reach out! You can contact us at:
        </p>
        <p>
          <strong>Seenup</strong><br>
          Email: info@seenup.com<br>
        </p>
        <p>
          Thank you for choosing SeenUp! Your privacy is as important to us as finding the perfect pizza topping. Enjoy your time on our site!
        </p>
      </q-card-section>
    </q-card>
  </q-page>
